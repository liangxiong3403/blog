...
//	}
     ...
     * @return
     */
    public static int getIntervalYears(String startTime, String endTime) {
        ...
        int result = Math.abs(startYear - endYear);
        return result;
    }
    ...
    public static int getIntervalMonths(String startTime, String endTime) {
        ...
        int result = Math.abs(startMonth - endMonth);
        return result;
    }
     ...
     * @return
     */
    public static int getIntervalDays(String startTime, String endTime) {
        Date start = DateUtil.stringToDate(startTime);
        Date end = DateUtil.stringToDate(endTime);
        int intervalDays = (int) ((Math.abs(start.getTime() - end.getTime())) / (24 * 60 * 60 * 1000));
        return intervalDays;
    }
     ...
     * @return
     */
    public static int getIntervalHours(String startTime, String endTime) {
        Date start = DateUtil.stringToDate(startTime);
        Date end = DateUtil.stringToDate(endTime);
        int intervalHours = (int) ((Math.abs(start.getTime() - end.getTime())) / (60 * 60 * 1000));
        return intervalHours;
    }

    /**
     * @return 返回系统当前指定格式的日期时间
     */
     ...
     * 获取UTC+8时区时间
     */
    public static int getUTC8Time() {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        format.setTimeZone(TimeZone.getTimeZone(ZoneId.SHORT_IDS.get("CTT")));
        return new Long(DateUtil.stringToDate(format.format(DateUtil.getNowDate("yyyy-MM-dd HH:mm:ss"))).getTime() / 1000).intValue();
    }
